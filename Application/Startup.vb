...
Module Startup
    ...
    ' Accessible by non-UI modules that expect a MainForm instance.
    ...
    Sub Main()
        ...
        ' =====================================================
        ' INITIALIZE DATABASE INFRASTRUCTURE (reliable wrapper)
        ' =====================================================
    ...
    Public Sub AdminUser(isAdmin As Boolean)
        ...
        ' Guard the control access (some builds may not have the control at constructor time)
        Try
